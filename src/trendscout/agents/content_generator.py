...
class ContentGeneratorAgent(BaseAgent):
    ...
    async def validate_result(self, result: Dict[str, Any]) -> bool:
        ...
        if (
            not isinstance(result["engagement_tips"], list)
            or not result["engagement_tips"]
        ):
            return False
    ...
    def _validate_input(self, data: Dict[str, Any]) -> bool:
        ...
        if data["target_platform"].lower() not in {
            "twitter",
            "reddit",
            "instagram",
            "linkedin",
    ...
    def _parse_result(self, result: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "content_ideas": [
                    {"title": "Error", "description": "Error parsing content ideas"}
                ],
